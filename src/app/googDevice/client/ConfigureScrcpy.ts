...
export class ConfigureScrcpy extends BaseClient<ParamsStreamScrcpy, ConfigureScrcpyEvents> {
    ...
    private updateVideoSettingsForPlayer(): void {
        ...
        if (player) {
            ...
            player.loadSettingsAsync(this.udid, this.displayInfo).then(({ videoSettings, fitToScreen }) => {
                this.fillInputsFromVideoSettings(videoSettings, fitToScreen);
            });
        }
    }
    ...
    private createUI(): HTMLElement {
        ...
        this.appendBasicInput(controls, {
            label: 'Bitrate',
            id: 'bitrate',
            range: { min: 524288, max: 20971520, step: 524288, formatter: Util.prettyBytes },
        });
        this.appendBasicInput(controls, {
            label: 'Max FPS',
            id: 'maxFps',
    ...
    private saveSettings = (): void => {
        ...
        if (videoSettings && player) {
            ...
            player.saveSettingsAsync(this.udid, videoSettings, fitToScreen, this.displayInfo);
        }
    };
